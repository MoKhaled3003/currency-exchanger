...
export default function Ethereum() {
  return (
    ...
    <path d="M12.3735 15.4297L17.9963 12.165L12.3735 9.65399V15.4297Z" fill="white" fillOpacity="0.2"/>
    <path d="M6.75 12.165L12.3735 15.4297V9.65399L6.75 12.165Z" fill="white" fillOpacity="0.602"/>
    </g>
    <defs>
    <clipPath id="clip0_21_2496">
